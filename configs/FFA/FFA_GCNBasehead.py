...
work_dir = './work_dirs_MICCAI_new/FFA6_new_set/resnet50_448_new/GCNBasehead_cooccurence_lr5e-3_e100'

model = dict(type='ImageClassifier',
    neck=None,
    head=dict(
        type='GCNClsHead_base',
        label_file='/users/lailai/sharedscratch/openmmlab/mmpretrain/data/FFA/train_class6.csv',
        name='FFA',
        itself=False,
        t=0,
        # num_classes=6,
