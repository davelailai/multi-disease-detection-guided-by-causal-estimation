...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',default='work_dirs_fundation/UWF/3Class/batch1/Res50_init_in1k/supervised_resnet50.py')
    parser.add_argument('--checkpoint', help='checkpoint file',default='work_dirs_fundation/UWF/3Class/batch1/Res50_init_in1k/best_multi-label_mAUC_epoch_30.pth')
    parser.add_argument(
        '--work-dir',
