...
from mmpretrain.models import HiViT, VisionTransformer,SoftMoEViT
...
class MAEHiViT(HiViT):
    ...
    def forward(
        ...
        if mask is None or False:
            ...
            return (x, mask, ids_restore)
from mmpretrain.models.backbones.soft_moe_vit import *
@MODELS.register_module()
class SMoE_MAEViT(VisionTransformer):
    """Vision Transformer for MAE pre-training.
